...
public class ${componentName}Definition extends AbstractComponentDefinition {
    ...
    public RuntimeInfo getRuntimeInfo(ExecutionEngine engine, ComponentProperties properties, ConnectorTopology connectorTopology) {
        ...
        try {
            return new JarRuntimeInfo(new URL(${componentName}FamilyDefinition.MAVEN_RUNTIME_URI),
                    DependenciesReader.computeDependenciesFilePath(${componentName}FamilyDefinition.MAVEN_GROUP_ID,
                    		${componentName}FamilyDefinition.MAVEN_RUNTIME_ARTIFACT_ID), RUNTIME_CLASS_NAME);
