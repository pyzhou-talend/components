 ...
 */
public abstract class FileIODefinition extends AbstractComponentDefinition{
    ...
    public FileIODefinition(String ComponentName) {
    ...
    public Class<? extends ComponentProperties>[] getNestedCompatibleComponentPropertiesClass() {
        return new Class[]{FileIOProperties.class};
    }
}
