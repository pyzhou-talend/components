...
public class TableInputTest {
    ...
    public ComponentService getComponentService() {
        if (componentService == null) {
            ...
            testComponentRegistry.registerComponentFamilyDefinition(new TableInputFamilyDefinition());
    ...
    @Test
    public void testTableInputRuntime() throws Exception {
        TableInputProperties props = (TableInputProperties) getComponentService().getComponentProperties("TableInput");

        File tempFile = File.createTempFile("TableInputTestFile", ".txt");
        try {
            ...
            TableInputReader reader = source.createReader(null);
